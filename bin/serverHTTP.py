...
# The following class handles the creation of a server that can work with POST and GET methods / the HTTP protocol
class S(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        # This function sets up the response string if a POST message is received from the phone
...
if __name__ == '__main__':
    # Each time coordinates are received by the sever, these are saved into a .csv file.
    f = open("coords.csv","w")
